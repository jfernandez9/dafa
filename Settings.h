...
#define BOARD_NAME                    "DAFA 01"        // Name of your product. Should match App Export request info.
#define BOARD_VENDOR                  "Tecnología DAFA"        // Name of your company. Should match App Export request info.
#define BOARD_TEMPLATE_ID             "TMPL0000"            // ID of the Tile Template. Can be found in Tile Template Settings

#define PRODUCT_WIFI_SSID             "DAFA 01"         // Name of the device, to be displayed during configuration. Should match export request info.
#define BOARD_CONFIG_AP_URL           "dafa.cc"      // Config page will be available in a browser at 'http://our-product.cc/'
